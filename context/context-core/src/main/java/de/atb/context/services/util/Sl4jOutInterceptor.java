 ...
 */
public class Sl4jOutInterceptor extends AbstractPhaseInterceptor<Message> {
	private final Logger logger = LoggerFactory
			.getLogger(Sl4jOutInterceptor.class);

	/**
	 * @param phase the interceptor's phase
	 */
	public Sl4jOutInterceptor(final String phase) {
		super(phase);
	}

	public Sl4jOutInterceptor() {
