...
public final class POKindCoreServiceMonitoringConfAMsImpl implements
	...
	public boolean POKindCoreServiceConfCloseAM(String name, ObjectKinds kind) {
		return true;
	}

	// TODO currently count and offset are not used
	public byte[] POKindCoreServiceConfReadAM(String name, String path,
	...
	public boolean POKindCoreServiceConfWriteAM(String name, ObjectKinds kind,
			byte[] buf) {
		return true;
	}
}
